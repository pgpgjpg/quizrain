...
class MultiChoice : public Quiz{
    ...
    string s1, s2, s3, s4;
public:
    MultiChoice(string question, int level, int score, int answer, string s1, string s2);
    MultiChoice(string question, int level, int score, int answer, string s1, string s2, string s3);
